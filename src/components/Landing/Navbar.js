    ...
    <nav className=" ">
      <div className='bg-gray-500  p-2'>
        ...
        <div className=' w-full flex items-center justify-between max-w-screen-lg mx-auto'>
            <div className="text-white  flex font-sans ">
                ...
                <span className="ml-2"> Email : Samsulganteng@Gmail.com</span>
            </div>
      ...
      <div className='bg-gray-200'>
        ...
        <div className="flex items-center space-x-4">
                ...
                <Link to="/category" className="text-black hover:text-gray-500">Kategori</Link>
            </div>
        <div className='flex'>
            <input 
            type='text'
            ...
            />
            <button className='rounded items-center bg-white px-3 py-2 flex' onClick={handleClick}><span className='pr-1'>Cari </span><BsSearch /> </button>
        </div>
            </div>
      </div>
    </nav>
